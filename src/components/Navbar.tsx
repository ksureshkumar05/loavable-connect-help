    ...
    <nav className="bg-white py-4 px-6 shadow-sm">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <Link to="/" className="text-gray-500 hover:text-blue-500 transition-colors font-medium">HOME</Link>
          <Link to="/support" className="text-gray-500 hover:text-blue-500 transition-colors font-medium">SUPPORT</Link>
          <Link to="/appointment-launch" className="text-blue-500 font-medium">APPOINTMENT SYSTEM</Link>
          <Link to="/appointments" className="text-gray-500 hover:text-blue-500 transition-colors font-medium">SCHEDULE APPOINTMENT</Link>
